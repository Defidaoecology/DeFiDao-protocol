...
This checks to see if the deployed byte-code matches this version of the DeFiDao Protocol.
...
(async function() {
  ...
  let deployArgs = [conf.underlying, conf.snktroller, conf.interestRateModel, conf.initialExchangeRateMantissa.toString(), conf.name, conf.symbol, conf.decimals, conf.admin];
