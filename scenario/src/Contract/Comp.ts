...
export interface snkScenarioMethods extends snkMethods {
...
export interface snk extends Contract {
  methods: snkMethods;
  name: string;
}

export interface snkScenario extends Contract {
  methods: snkScenarioMethods;
  name: string;
}
