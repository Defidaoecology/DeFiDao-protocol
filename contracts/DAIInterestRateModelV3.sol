...
/**
  * @title DeFiDao's DAIInterestRateModel Contract (version 3)
  * @author DeFiDao (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original DeFiDao Protocol whitepaper.
