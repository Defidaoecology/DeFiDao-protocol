...
/**
 * @title The DeFiDao Faucet Test Token
 * @author DeFiDao
...
/**
 * @title The DeFiDao Faucet Test Token (non-standard)
 * @author DeFiDao
 * @notice A simple test token that lets anyone get more of it.
 */
...
/**
 * @title The DeFiDao Faucet Re-Entrant Test Token
 * @author DeFiDao
...
contract FaucetTokenReEntrantHarness {
    ...
    modifier reEnter(string memory funName) {
        ...
        if (snkareStrings(_reEntryFun, funName)) {
    ...
    function snkareStrings(string memory a, string memory b) internal pure returns (bool) {
