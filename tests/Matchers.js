...
const { snktrollerErr, TokenErr, IRErr, MathErr } = require('./Errors');
...
expect.extend({
  ...
  toHaveTrollError(actual, expectedErrorName) {
    return hasError.call(this, actual, expectedErrorName, snktrollerErr);
  },
  ...
  toHaveTrollFailure(result, err, info, detail=undefined) {
    return hasFailure.call(this, result, err, info, detail, snktrollerErr, 'toHaveTrollFailure');
  },
  ...
  toHaveTrollReject(result, info, detail) {
    return hasFailure.call(this, result, 'snkTROLLER_REJECTION', info, detail && snktrollerErr.Error[detail], TokenErr, 'toHaveTrollReject');
  },

  toHaveTrollErrorTuple(result, tuple, cmp=undefined) {
    return hasErrorTuple.call(this, result, tuple, snktrollerErr, cmp);
  },
