...
contract CErc20DelegatorCertora is CErc20Delegator {
    ...
    constructor(address underlying_,
                ...
                bytes memory becomeImplementationData) public CErc20Delegator(underlying_, snktroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, admin_, implementation_, becomeImplementationData) {
        snktroller;       // touch for Certora slot deduction
