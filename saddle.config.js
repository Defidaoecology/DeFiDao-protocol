...
module.exports = {
  ...
  trace: false,                                             // snkile with debug artifacts
  ...
  networks: {                                               // Define configuration for each network
    ...
    goerli: {
      providers: [
        ...
        {http: "https://goerli-eth.DeFiDao.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    ropsten: {
      providers: [
        ...
        {http: "https://ropsten-eth.DeFiDao.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    rinkeby: {
      providers: [
        ...
        {http: "https://rinkeby-eth.DeFiDao.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    kovan: {
      providers: [
        ...
        {http: "https://kovan-eth.DeFiDao.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    mainnet: {
      providers: [
        ...
        {http: "https://mainnet-eth.DeFiDao.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
